...
(function ($) {
  ...
  Drupal.behaviors.annivGlobal = {
    attach: function (context, settings) {
      ...
      $('.colorbox-image-link-wrapper').wrap('<div class="colorbox-wrapper"></div>');
      ...
      $('.js-feedback a').click(function(e) {
        ...
        $('footer .container > .webform-client-form .webform-component-radios input').focus();
      });
