 ...
 */
?>
<div class="container node-detail">
  <section class="node-detail-wrapper">
    ...
    <?php
      if (isset($content['field_30ya_pictures'])):
        hide($content['field_30ya_pictures']);
      endif;
    ...
    <?php if (isset($content['field_30ya_pictures'])): ?>
      <h2>
        <?php print t('Pictures'); ?>
      </h2>
    <?php endif; ?>
  </section>
  <?php if (isset($content['field_30ya_pictures'])): ?>
