...
(function($) {
  $(document).ready(function() {
    /* MOBILE MENU */
    $('.mobile-subnav-wrapper button').click(function(){
      ...
      $(this).find('span').toggleClass('active');
        ...
        function activeTab(){
          ...
          $('.p a[href="#' + hashUrl + '"]').tab('show');
        };

        /* CONTACT LIST */
        /* GENERATE FILTER LIST */
         $(".contact-details-container .contactid").each(function(){
          ...
          /* DROPDOWN MENU */
          $('.contact-filter-selected,.contact-filters li').click(function(){
            openDropdown();
          });
          ...
          $('.contact-details-container').click(function(event){
          ...
          $('.contact-filters ul').delegate("li", "click", function() {
          ...
          $('.feedbackform .form-radio').click(function(){
            $('.feedbackform .form-submit').fadeIn();
          });

          /* MOBILE NAV TEST */
          /* DEPLOY MAIN NAV PANEL */
          $('.mobile-nav-bar button,.mobile-nav-shadow').click(function(){
            $(".mobile-nav-panel").toggle('slide');
          ...
          $(".mobile-nav-search input").focus(function() {
            ...
            /* ON FOCUS OF THE SEARCH FIELD */
            $(".mobile-search-shadow").click(function() {
            ...
            /* EXPAND TOOL PANEL */
            $(".nav-tool-expand").click(function(){
