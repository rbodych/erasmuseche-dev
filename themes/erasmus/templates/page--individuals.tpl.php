 ...
 * @link NA
 *
 * Ec_resp's theme implementation to display a individuals Drupal page.
 *
  ...
  <div class="modal-dialog">
    <div id="ErasmusDisclaimer" class="modal-content">
      <div class="modal-header">
        <img
          src="<?php print $GLOBALS['base_url'] .
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-md-12" id="modalbottom">
            <a type="button" class="link-more"
               data-dismiss="modal"><?php print $modalclose; ?></a>
...
<div id="layout-body1">
  ...
  <div class="row hidden">
    ...
    col-sm-0 col-xs-0 sidebar-left visible-lg visible-md">
