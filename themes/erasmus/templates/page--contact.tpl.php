...
<div class="region-featured-wrapper <?php print ($has_responsive_sidebar ? 'sidebar-visible-sm' : ''); ?>">
  ...
  <header class="contactbg" role="banner">
    <div id="layout-body imgbg" class="container">
      <div class="col-xs-12 col-md-10 col-md-offset-1 animated bounceInDown" id="intro-box">
        <h1><?php print $contacttitle; ?></h1>
        <hr>
        <p><?php print $contactsubtitle; ?></p>
      </div>
    </div>
  </header>
</div>
