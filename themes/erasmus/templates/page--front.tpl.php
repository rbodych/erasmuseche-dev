      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-md-12" id="modalbottom">
            <a type="button" class="link-more" data-dismiss="modal"><?php print $modalclose; ?></a>
...
<div id="layout-body" class="container">
  <div class="row marginthirty">
    <div id="sidebar-left" class="col-lg-8 col-md-8 col-sm-12 col-xs-12 sidebar-left visible-lg visible-md visible-sm visible-xs">
      <div class="region region-sidebar-left">
        <div class="block-region">
          <div class="region region-sidebar-right" data-thmr="thmr_116">
            <div id="block" class="block panel panel-default clearfix" data-thmr="thmr_115">
    ...
    <div id="sidebar-left" class="col-lg-4 col-md-4 col-sm-4 col-xs-12 sidebar-left visible-lg visible-md visible-sm visible-xs">
      <div class="region region-sidebar-left">
        <div class="block-region">
